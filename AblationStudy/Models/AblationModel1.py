...
if __name__ == "__main__":
    ...
    with strategy.scope():
        ...
        # Run
        SaveFilePath = './Logs/SaveAblation1_{epoch:d}_{binary_crossentropy:.5f}_{auc:.5f}_{ClLoss:.5f}_{val_binary_crossentropy:.5f}_{val_auc:.5f}_{val_ClLoss:.5f}.hdf5'
        ...
        SaveFilePath = './Logs/ShapeBin_Ablation1_end.hdf5'
